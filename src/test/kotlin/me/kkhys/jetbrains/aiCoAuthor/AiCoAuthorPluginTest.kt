...
class AiCoAuthorPluginTest : BasePlatformTestCase() {
    ...
    fun testCoAuthoredByFormat() {
        ...
        assertTrue("Co-Authored-By format should match Git trailer standard", 
    ...
    fun testTextComponentIdentification() {
        ...
        assertTrue("Visible EditorTextField should be identified as commit field",
        ...
        assertTrue("Multi-line editable JTextArea should be identified as commit field",
    ...
    fun testTextComponentRejection() {
        ...
        assertFalse("Invisible component should be rejected",
        ...
        assertFalse("Single-line JTextArea should be rejected",
        ...
        assertFalse("Non-editable JTextArea should be rejected",
    ...
    fun testDuplicationPrevention() {
        ...
        assertFalse("Should prevent duplication when Claude co-author already exists",
            shouldAddCoAuthor(existingText))

        val differentCoAuthor = "Initial commit message\n\nCo-Authored-By: Someone Else <other@example.com>"
        
        assertTrue("Should allow adding Claude when different co-author exists",
    ...
    fun testActionRegistration() {
        ...
        assertTrue("Registered action should be instance of GenerateCommitMessageAction",
    ...
    fun testActionTemplate() {
        ...
        assertEquals("Action description should be correct", 
            "Add Claude as co-author to your commit message", presentation.description)
    }
    ...
    fun testCommitMessageValidation() {
        ...
        assertTrue("Empty message should allow co-author addition",
            shouldAddCoAuthor(""))
        
        // Test standard commit message
        assertTrue("Standard commit message should allow co-author addition",
            shouldAddCoAuthor("feat: add new feature\n\nThis feature adds something cool."))
        
        // Test message already containing Claude co-author
        assertFalse("Message with Claude co-author should prevent duplication",
            shouldAddCoAuthor("feat: add feature\n\nCo-Authored-By: Claude <noreply@anthropic.com>"))
        
        // Test message with partial Claude match (should still prevent)
        assertFalse("Message with partial Claude match should prevent duplication",
    ...
    fun testTextFormattingEdgeCases() {
        ...
        assertEquals("Should properly handle multi-line messages", 
            "$messageWithNewlines\n\n$coAuthor", result2)
    }
     ...
     */
    private fun isLikelyCommitMessageFieldSimulation(component: Any, text: String): Boolean {
     ...
     */
    private fun formatUpdatedText(currentText: String, coAuthoredBy: String): String {
